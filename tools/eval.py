...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        default="configs/cityscapes/sanet_cityscapes_L.yaml",
                        type=str)
...
def main():
    ...
    # build model
    model = model = models.sanet.get_seg_model(config, imgnet_pretrained=False)
    # model = model = models.sanet.get_pred_model()
